...
will be automatically refreshed on the next navigation (see [Dirty Pages](state.md#dirty-pages)).
...
[Metadata](core-concepts.md#loadresult--metadata) and return it from the `load` lambda. All four
initializer
