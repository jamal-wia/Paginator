...
commonMain.dependencies {
  ...
  implementation(platform("io.github.jamal-wia:paginator-bom:10.2.0"))
...
mature (current version 10.2.0), and covered with documentation. Feedback and stars help.

- **GitHub:** [github.com/jamal-wia/Paginator](https://github.com/jamal-wia/Paginator)
- **Maven Central:** `io.github.jamal-wia:paginator-offset:10.2.0` /
  `paginator-cursor:10.2.0` (or via the `paginator-bom`)
