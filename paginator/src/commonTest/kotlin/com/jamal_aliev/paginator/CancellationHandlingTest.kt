...
class CancellationHandlingTest {
    ...
    fun `jump cancellation restores context window and page state`() = runTest {
        ...
        val page1Before = paginator.cache.getStateOf(1)
        val page2Before = paginator.cache.getStateOf(2)
        val page3Before = paginator.cache.getStateOf(3)
        ...
        assertEquals(page1Before!!.data, paginator.cache.getStateOf(1)!!.data)
        assertEquals(page2Before!!.data, paginator.cache.getStateOf(2)!!.data)
        assertEquals(page3Before!!.data, paginator.cache.getStateOf(3)!!.data)
    }
    ...
    fun `goNextPage cancellation restores page state`() = runTest {
        ...
        assertNull(paginator.cache.getStateOf(4))
    ...
    fun `restart cancellation restores context window and page state`() = runTest {
        ...
        val startBefore = paginator.cache.startContextPage
        val endBefore = paginator.cache.endContextPage
        val page1DataBefore = paginator.cache.getStateOf(1)!!.data.toList()
        ...
        assertTrue(paginator.cache.getStateOf(1)!!.isSuccessState())
        assertEquals(page1DataBefore, paginator.cache.getStateOf(1)!!.data)
    }
    ...
    fun `refresh cancellation restores all page states`() = runTest {
        ...
        val page1DataBefore = paginator.cache.getStateOf(1)!!.data.toList()
        val page2DataBefore = paginator.cache.getStateOf(2)!!.data.toList()
        ...
        assertTrue(paginator.cache.getStateOf(2)!!.isSuccessState())
        assertEquals(page1DataBefore, paginator.cache.getStateOf(1)!!.data)
        assertEquals(page2DataBefore, paginator.cache.getStateOf(2)!!.data)
