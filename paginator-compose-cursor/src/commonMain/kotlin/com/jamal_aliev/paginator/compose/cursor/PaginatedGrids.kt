...
/**
 * Turnkey, scroll-anchor-safe paginated `LazyVerticalGrid` for a [CursorPaginator]. The boundary
 * indicators animate on the top / bottom edge. [key] is required for scroll-anchor preservation.
 */
@Composable
fun <K : Any, T> PaginatedLazyVerticalGrid(
...
/**
 * Horizontal turnkey, scroll-anchor-safe paginated `LazyHorizontalGrid` for a [CursorPaginator]. The
 * boundary indicators animate on the start / end edge. [key] is required for scroll-anchor
 * preservation.
 */
@Composable
fun <K : Any, T> PaginatedLazyHorizontalGrid(
    paginator: CursorPaginator<K, T>,
    rows: GridCells,
    modifier: Modifier = Modifier,
    state: LazyGridState = rememberLazyGridState(),
