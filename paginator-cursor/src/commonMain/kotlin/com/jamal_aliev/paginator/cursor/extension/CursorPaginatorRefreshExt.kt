 ...
 */
suspend fun <K : Any, T> CursorPaginator<K, T>.refreshAll(
    ...
    initProgressState: InitializerCursorProgressPage<K, T> = this.core.initializerProgressPage,
    initSuccessState: InitializerCursorSuccessPage<K, T> = this.core.initializerSuccessPage,
    initErrorState: InitializerCursorErrorPage<K, T> = this.core.initializerErrorPage,
) {
