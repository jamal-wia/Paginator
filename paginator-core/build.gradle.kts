...
mavenPublishing {
    ...
    coordinates(group.toString(), "paginator-core", version.toString())

    pom {
        name.set("Paginator Core — shared primitives for the Paginator suite")
        description.set(
            "Shared core types of the Paginator pagination library: PageState, PaginatorUiState, " +
                    "PagingCache base interfaces, bookmarks, exceptions, logger, interweave, " +
                    "prefetch options, and reactive cache plumbing. Consumed by paginator-offset, " +
                    "paginator-cursor, and the UI binding modules. Pick this module if you are " +
                    "implementing your own paginator strategy on top of the shared abstractions."
        )
...
android {
    namespace = "com.jamal_aliev.paginator.core"
    compileSdk = 36
