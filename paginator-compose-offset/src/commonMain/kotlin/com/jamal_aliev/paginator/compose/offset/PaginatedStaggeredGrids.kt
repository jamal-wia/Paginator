...
/**
 * Turnkey, scroll-anchor-safe paginated `LazyVerticalStaggeredGrid` for an offset [Paginator]. The
 * boundary indicators animate on the top / bottom edge. See [PaginatedLazyColumn] for the full
 * parameter contract ([key] is required).
 */
@Composable
fun <T> PaginatedLazyVerticalStaggeredGrid(
...
/**
 * Horizontal turnkey, scroll-anchor-safe paginated `LazyHorizontalStaggeredGrid` for an offset
 * [Paginator]. The boundary indicators animate on the start / end edge. See [PaginatedLazyColumn]
 * for the full parameter contract ([key] is required).
 */
@Composable
fun <T> PaginatedLazyHorizontalStaggeredGrid(
    paginator: Paginator<T>,
